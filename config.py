...
PORT = 16022
OUT_WEB_DIR = (
    "/www/avosouth.wr.usgs.gov/htdocs/infrasound"  # html & image ouptut directory
)
            ...
            dict(
                {
                    ...
                    "digouti": (1 / 400000)
                    / 0.0275,  # convert counts to Pressure in Pa (Centaur + Chaparral Vx2 mics)
                    "volcano": [
                    ...
                    "SCNL": [
                        {
                            "scnl": "OKIF.HDF.AV.01",
                            "sta_lat": 53.41083004,
                            "sta_lon": -167.91426701,
                        },
                        {
                            "scnl": "OKIF.HDF.AV.02",
                            "sta_lat": 53.41001901,
                            "sta_lon": -167.91366301,
                        },
                        {
                            "scnl": "OKIF.HDF.AV.03",
                            "sta_lat": 53.40998297,
                            "sta_lon": -167.91499598,
                        },
                        {
                            "scnl": "OKIF.HDF.AV.04",
                            "sta_lat": 53.41029796,
                            "sta_lon": -167.91431696,
                        },
                        {
                            "scnl": "OKIF.HDF.AV.05",
                            "sta_lat": 53.41038496,
                            "sta_lon": -167.91331901,
                        },
                        {
                            "scnl": "OKIF.HDF.AV.06",
                            "sta_lat": 53.41045604,
                            "sta_lon": -167.91544802,
                        },
                    ],
                    "digouti": 1
                    / (
                        419430 * 0.03
                    ),  # convert counts to Pressure in Pa (Q330 + Chaparral 64Vx original)
                    "volcano": [
            ...
            dict(
                {
                    ...
                    "SCNL": [
                        {
                            "scnl": "CLCO.HDF.AV.01",
                            "sta_lat": 52.7864125000,
                            "sta_lon": -169.7229250000,
                        },
                        {
                            "scnl": "CLCO.HDF.AV.02",
                            "sta_lat": 52.7871866667,
                            "sta_lon": -169.7244333330,
                        },
                        {
                            "scnl": "CLCO.HDF.AV.03",
                            "sta_lat": 52.7874600000,
                            "sta_lon": -169.7210166667,
                        },
                        {
                            "scnl": "CLCO.HDF.AV.04",
                            "sta_lat": 52.7861266667,
                            "sta_lon": -169.7203966667,
                        },
                        {
                            "scnl": "CLCO.HDF.AV.05",
                            "sta_lat": 52.7851866667,
                            "sta_lon": -169.7250066667,
                        },
                        {
                            "scnl": "CLCO.HDF.AV.06",
                            "sta_lat": 52.785861,
            ...
            dict(
                {
                    ...
                    "digouti": 1
                    / 33505.5968,  # convert counts to Pressure in Pa 01-Jun-2021
                    "volcano": [
                        {"name": "Bogoslof", "v_lat": 53.9310, "v_lon": -168.0360},
                        {
                            "name": "Veniaminof",
            ...
            dict(
                {
                    ...
                    "digouti": (1 / 400000)
                    / 0.0275,  # new sensors and locations installed Feb 20, 2024
                    "volcano": [
